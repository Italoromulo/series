...
searchInput.addEventListener('input', (event) => {
  ...
  const emAltaSeries = document.querySelector('.container'); 
  ...
  if (value !== '') {
    items.forEach(item => {
      ...
      if (match) {
        ...
        if (emAltaSeries.contains(item)) emAltaHasMatch = true; 
    ...
    emAltaSeries.style.display = emAltaHasMatch ? '' : 'none'; 
